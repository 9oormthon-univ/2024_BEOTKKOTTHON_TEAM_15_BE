...
public interface NotificationService {
    void saveNotification(Long memberId, FcmTokenRequestDto fcmTokenRequestDto);  // 로그인 직후 바로, fcm토큰 DB에 저장.
    String getNotificationToken();
    void sendNotification(Long memberId, NotificationDto notificationDto) throws ExecutionException, InterruptedException;
